...
public class Plan extends javax.swing.JFrame {
    ...
    public static String[] AgregarElementosTabla(PlanDTO plan, String nombreMateria) {

        String Dato[] = new String[3];
        Dato[0] = Integer.toString(plan.getIdPlan());
        Dato[1] = nombreMateria;
        Dato[2] = plan.getNombrePlan();
        return Dato;
    }
     ...
     */
    public Plan(ProfesorManagerImpl profesorManagerRe, PlanManagerImpl planManagerRe, DescripcionManagerImpl descripcionManagerRe, EstudianteManagerImpl estudianteManagerRe, GradoManagerImpl gradoManagerRe, GradoMateriaManagerImpl gradoMateriaManagerRe, GrupoManagerImpl grupoManagerRe, MateriaManagerImpl materiaManagerRe, NotasManagerImpl notasManagerRe, ProfesorMateriaManagerImpl profesorMateriaManagerRe) {
    ...
    private void initComponents() {
        ...
        JtextNombre.setText("NombrePlan");
        ...
        JtextNombre.setBounds(40, 40, 90, 30);

        Jmateria.setText("NombreMateria");
        getContentPane().add(Jmateria);
        Jmateria.setBounds(40, 80, 110, 30);
        ...
        jButton1.setBounds(40, 150, 120, 30);
        ...
        Eliminar1.setText("Id del plan a eliminar o a consultar");
        ...
        jLabel1.setText("Consultar Por Materia");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (JtextNombre.getText().equals("NombrePlan") || Jmateria.getText().equals("NombreMateria") || JtextNombre.getText().length() == 0 || Jmateria.getText().length() == 0) {
            ...
            if (materiaManager.consultarMateriaPorNombre(Jmateria.getText()) != null) {
                ...
                plan.setNombrePlan(JtextNombre.getText());
                materia = materiaManager.consultarMateriaPorNombre(Jmateria.getText());
                plan.setIdMateria(materia.getIdmateria());
                planManager.registrarPlan(plan);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ArrayList<PlanDTO> listaPlan = planManager.traerListaPlan();
        for (PlanDTO plan : listaPlan) {
            MateriaDTO materia = new MateriaDTO();
            materia = materiaManager.consultarMateria(plan.getIdMateria());
            String Dato[] = Plan.AgregarElementosTabla(plan, materia.getNombreMateria());
            modelo.addRow(Dato);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Eliminar1.getText().equals("Id del plan a eliminar o a consultar") || Eliminar1.getText().length() == 0) {
            JOptionPane.showMessageDialog(null, "Debes ingresar algo en los campos");
        } else {
            if (this.isNumeric(Eliminar1.getText())) {
                if (planManager.consultarPlan(Integer.parseInt(Eliminar1.getText())) != null) {
                    planManager.eliminarPlan(Integer.parseInt(Eliminar1.getText()));
                    this.jButton2ActionPerformed(evt);
                    JOptionPane.showMessageDialog(null, "El Plan se ha eliminado");
                } else {
                    JOptionPane.showMessageDialog(null, "Ese Id no esta registrado");
                }

            } else {
                JOptionPane.showMessageDialog(null, "El id Plan debe ser un caracter numerico");
            }
        }
        Eliminar1.setText("Id del plan a eliminar o a consultar");
    ...
    private void Consulta1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Consulta1ActionPerformed
        ...
        if (Jopcion.getText().length() == 0) {
            ...
            if (materiaManager.consultarMateriaPorNombre(Jopcion.getText()) != null) {
                ...
                ArrayList<PlanDTO> listaPlanes = planManager.consultarPlanPorMateria(materia.getIdmateria());
                for (PlanDTO planN : listaPlanes) {
                    String Dato[] = Plan.AgregarElementosTabla(planN, materia.getNombreMateria());
                    modelo.addRow(Dato);
                }
                Jopcion.setText("");
            } else {
                JOptionPane.showMessageDialog(null, "Esa materia no se encuentra registrada");
                Jopcion.setText("");
            }
        }
    ...
    private void Consulta2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Consulta2ActionPerformed
        if (Eliminar1.getText().equals("Id del plan a eliminar o a consultar") || Eliminar1.getText().length() == 0) {
            ...
            if (this.isNumeric(Eliminar1.getText())) {
                if (planManager.consultarPlan(Integer.parseInt(Eliminar1.getText())) != null) {
                    PlanDTO plan = new PlanDTO();
                    plan = planManager.consultarPlan(Integer.parseInt(Eliminar1.getText()));
                    modelo.setRowCount(0);
                    MateriaDTO materia = new MateriaDTO();
                    materia = materiaManager.consultarMateria(plan.getIdMateria());
                    String Dato[] = Plan.AgregarElementosTabla(plan, materia.getNombreMateria());
